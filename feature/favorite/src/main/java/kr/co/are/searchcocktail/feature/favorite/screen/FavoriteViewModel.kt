...
import kr.co.are.searchcocktail.domain.usecase.DeleteAllFavoriteCocktailUseCase
...
class FavoriteViewModel @Inject constructor(
    ...
    private val deleteAllFavoriteCocktailUseCase: DeleteAllFavoriteCocktailUseCase,
) : ViewModel() {
    ...
    fun deleteAllFavoriteCocktail() {
        viewModelScope.launch {
            deleteAllFavoriteCocktailUseCase().collect { resultDomain ->
                when (resultDomain) {
                    is kr.co.are.searchcocktail.domain.model.ResultDomain.Success -> {
                        loadFavoriteCocktail()
                    }
