                    ...
                    if (list?.isNotEmpty() == true) {
                        emit(ResultData.Success(list.map {
                            DrinkInfoEntity(
                                ...
                                ingredientsEs = it.strInstructionsEs,
                                ingredientsDe = it.strInstructionsDe,
                                ingredientsFr = it.strInstructionsFr,
                                ingredientsIt = it.strInstructionsIt,
                                ingredientsZhHans = it.strInstructionsZhHans,
                                ingredientsZhHant = it.strInstructionsZhHant,
